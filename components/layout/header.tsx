        ...
        >
            ...
            <div className="flex items-center gap-1.5">
                ...
                <div className="relative" ref={userRef}>
                    ...
                    >
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-emerald-400 to-green-600 flex items-center justify-center shadow-md shrink-0">
                    ...
                    {userOpen && (
                        <div className={cn(
                            ...
                            <div className="px-4 py-3 border-b border-border flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-400 to-green-600 flex items-center justify-center shadow shrink-0">
                            ...
                            <div className="py-1.5">
                                {[
                                    ...
                                    <button
                                        ...
                                        className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-muted-foreground hover:text-emerald-400 hover:bg-emerald-500/10 transition-colors"
                                    >
