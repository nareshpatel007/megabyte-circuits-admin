  ...
  const Content = ({ mobile = false }: { mobile?: boolean }) => {
    ...
    return (
      <div
        ...
        style={{
          background: "linear-gradient(180deg, hsl(224 60% 5%) 0%, hsl(224 55% 7%) 100%)",
        }}
      >
        {/* Logo Row */}
        <div
        ...
        >
          <div className={cn("flex items-center gap-2.5 min-w-0", isCollapsed && "justify-center")}>
            <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-cyan-400 to-blue-600 flex items-center justify-center shrink-0 shadow-lg glow-primary">
              <CircuitBoard className="w-4 h-4 text-white" />
            </div>
            {!isCollapsed && (
              <div className="min-w-0 leading-tight">
                <p className="text-sm font-700 text-white tracking-wide">PCB Admin</p>
                <p className="text-[10px] text-sidebar-muted">Manufacturing Panel</p>
              </div>
            )}
          </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-gradient-to-r from-cyan-500/20 to-blue-500/10 text-cyan-400 border border-cyan-500/25 shadow-sm"
        ...
        {!isCollapsed && (
          <div className="p-3 border-t border-sidebar-border">
            <div className="flex items-center gap-2.5 px-2 py-2 rounded-xl bg-sidebar-accent/50">
              <div className="w-7 h-7 rounded-full bg-gradient-to-br from-cyan-400 to-blue-600 flex items-center justify-center text-white text-[10px] font-700 shrink-0">
                AD
              </div>
