...
export const ALL_MENU_ROUTES: MenuRoute[] = [
    ...
    { href: "/admin/blogs", permission: "blog.view" },
    { href: "/admin/blog-categories", permission: "blog_category.view" },
    { href: "/admin/blog-tags", permission: "blog_tag.view" },
    ...
    { href: "/settings/jlcpcb", permission: ["settings.general"] },
