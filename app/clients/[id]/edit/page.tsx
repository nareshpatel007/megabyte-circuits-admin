...
export default function EditClientPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <DashboardLayout title={`Edit Client #${id}`} subtitle="Update client profile & account status" action={backButton}>
      {loading ? (
        ...
        <div className="w-full space-y-6 animate-in fade-in duration-300">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h1 className="text-xl font-extrabold text-foreground tracking-tight">Edit Client Details</h1>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Modify personal information, company GSTIN, or account status for {fullDisplayName}.
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Right Column: Preview & Save Actions */}
