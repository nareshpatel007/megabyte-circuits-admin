                                        ...
                                        <>
                                            ...
                                            <td className="py-3.5 px-4">
                                                <div className="flex items-center gap-2">
                                                    <span className="w-3.5 h-3.5 rounded-full shadow-sm shrink-0 border border-black/10 dark:border-white/20" style={{ backgroundColor: item.color || "#10b981" }} />
                                                    <span className="font-mono text-xs text-foreground font-bold uppercase">{item.color || "#10b981"}</span>
                                                </div>
                                            </td>
                                            <td className="py-3.5 px-4 font-bold text-foreground text-sm">{item.name}</td>
                                            <td className="py-3.5 px-4 text-center font-mono font-bold text-foreground">{item.sort_order}</td>
                                            <td className="py-3.5 px-4 text-right">
                                                <div className="flex items-center justify-end gap-1">
                                                    <button
                                                        ...
                                                        disabled={actionLoading}
                                                        className="p-2 text-foreground/70 hover:text-emerald-500 hover:bg-emerald-500/10 rounded-lg transition-all cursor-pointer disabled:opacity-50"
                                                        title="Edit Status"
                                                    >
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={actionLoading}
                                                        className="p-2 text-foreground/70 hover:text-red-500 hover:bg-red-500/10 rounded-lg transition-all cursor-pointer disabled:opacity-50"
                                                        title="Delete Status"
                                                    >
