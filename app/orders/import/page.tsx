...
export default function ImportPage() {
    ...
    return (
        <DashboardLayout
            title="PCB Manufacturing Import"
            subtitle="Upload manufacturer Excel files, preview staged data, fix cell validation errors, and execute background imports safely."
            action={headerAction}
        >
