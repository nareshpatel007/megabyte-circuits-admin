                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-1.5 bg-muted/50 p-1 rounded-2xl border border-border/60 shrink-0">
                            <button
                                ...
                                className={`px-4 py-1.5 rounded-xl text-xs font-bold transition-all ${filterStatus === "all"
                            ...
                            <button
                                type="button"
                                onClick={() => setFilterStatus("invalid")}
                                className={`px-4 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 ${filterStatus === "invalid"
                            ...
                            <button
                                ...
                                className={`px-4 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 ${filterStatus === "valid"
                                                    ...
                                                    <td className="p-2">
                                                        <div className="space-y-0.5">
                                                            <Input
                                                                ...
                                                                className={`h-8 text-xs font-mono rounded-lg border bg-card ${orderDateErr
                                                    ...
                                                    <td className="p-2">
                                                        <div className="space-y-0.5">
                                                            <Input
                                                                ...
                                                                className={`h-8 text-xs font-mono rounded-lg border bg-card ${launchDateErr
                                                                    ? "border-rose-500 ring-2 ring-rose-500/40 bg-rose-500/15 font-bold text-rose-600 dark:text-rose-400"
                                                                    : "border-border/80"
                                                                    }`}
                                                            />
                                                    ...
                                                    <td className="p-2">
                                                        <div className="space-y-0.5">
                                                            <Input
                                                                ...
                                                                className={`h-8 text-xs font-mono rounded-lg border bg-card ${deliveryDateErr
                                                                    ? "border-rose-500 ring-2 ring-rose-500/40 bg-rose-500/15 font-bold text-rose-600 dark:text-rose-400"
                                                                    : "border-border/80"
                                                                    }`}
                                                            />
                                                    ...
                                                    <td className="p-2">
                                                        <div className="space-y-0.5">
                                                            <Input
                                                                ...
                                                                className={`h-8 text-xs font-bold rounded-lg border bg-card ${customerErr
                                                    ...
                                                    <td className="p-2">
                                                        <div className="space-y-0.5">
                                                            <Input
                                                                ...
                                                                className={`h-8 text-xs font-mono font-bold rounded-lg border bg-card ${pnErr
                                                                    ? "border-rose-500 ring-2 ring-rose-500/40 bg-rose-500/15 text-rose-600 dark:text-rose-400"
                                                                    : "border-border/80"
                                                                    }`}
                                                            />
                                                    ...
                                                    <td className="p-2 text-center">
                                                        <div className="space-y-0.5">
                                                            <Input
                                                                ...
                                                                placeholder="Qty"
                                                                className={`h-8 text-xs font-mono text-center font-bold rounded-lg border bg-card ${qtyErr
                                                                    ? "border-rose-500 ring-2 ring-rose-500/40 bg-rose-500/15 text-rose-600 dark:text-rose-400"
                                                                    : "border-border/80"
                                                                    }`}
                                                            />
                                                    ...
                                                    <td className="p-2 text-center">
                                                        <div className="space-y-0.5">
                                                            <Input
                                                                ...
                                                                className={`h-8 text-xs font-mono text-center rounded-lg border bg-card ${launchErr
                                                                    ? "border-rose-500 ring-2 ring-rose-500/40 bg-rose-500/15 font-bold text-rose-600 dark:text-rose-400"
                                                                    : "border-border/80"
                                                                    }`}
                                                            />
                                                    ...
                                                    <td className="p-2 text-center">
                                                        <div className="space-y-0.5">
                                                            <Input
                                                                ...
                                                                className={`h-8 text-xs font-mono text-center rounded-lg border bg-card ${panelErr
                                                                    ? "border-rose-500 ring-2 ring-rose-500/40 bg-rose-500/15 font-bold text-rose-600 dark:text-rose-400"
                                                                    : "border-border/80"
                                                                    }`}
                                                            />
                                                    ...
                                                    <td className="p-2 text-center">
                                                        <div className="space-y-0.5">
                                                            <Input
                                                                ...
                                                                className={`h-8 text-xs font-mono text-center font-bold rounded-lg border bg-card ${finalQtyErr
                                                                    ? "border-rose-500 ring-2 ring-rose-500/40 bg-rose-500/15 text-rose-600 dark:text-rose-400"
                                                    ...
                                                    <td className="p-2">
                                                        <div className="space-y-0.5">
                                                            <Input
                                                                ...
                                                                className={`h-8 text-xs font-semibold rounded-lg border bg-card ${statusErr
                                                                    ? "border-rose-500 ring-2 ring-rose-500/40 bg-rose-500/15 font-bold text-rose-600 dark:text-rose-400"
                                                                    : "border-border/80"
                                                                    }`}
                                                            />
                                                    ...
                                                    <td className="p-2">
                                                        <div className="space-y-0.5">
                                                            <Input
                                                                ...
                                                                className={`h-8 text-xs font-mono rounded-lg border bg-card ${billErr
                                                                    ? "border-rose-500 ring-2 ring-rose-500/40 bg-rose-500/15 font-bold text-rose-600 dark:text-rose-400"
                                                                    : "border-border/80"
                                                                    }`}
                                                            />
